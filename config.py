...
NUM_FINETUNE_EPOCHS = 20  # İnce ayar için epoch sayısı (küçük veri setleri için 10-15 arası önerilir)
...
ADAPTER_REDUCTION_FACTOR = 16  # Adapter'ın öğrenme kapasitesi. Düşük değer = daha fazla parametre, potansiyel olarak daha yüksek doğruluk.