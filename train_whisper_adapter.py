...
class WhisperPersonalizedTrainer:
    ...
    def load_model_and_processor(self):
        ...
        self.model = WhisperForConditionalGeneration.from_pretrained(self.base_model_name)
    ...
    def train(self):
        ...
        train_ds = self.prepare_dataset(self.user_data_path / "train.csv")
        eval_ds = self.prepare_dataset(self.user_data_path / "eval.csv")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_model", type=str, default="openai/whisper-large-v2")
